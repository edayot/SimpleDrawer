...
[![Modrinth](https://img.shields.io/modrinth/dt/simpledrawer?logo=modrinth&label=Modrinth
)](https://modrinth.com/datapack/simpledrawer) 
<picture> <source media="(prefers-color-scheme: dark)" srcset="https://github.com/edayot/ItemIO/blob/master/docs/assets/download_ffffff.svg?raw=true"> <source media="(prefers-color-scheme: light)" srcset="https://github.com/edayot/ItemIO/blob/master/docs/assets/download_000000.svg?raw=true"> <img alt="Shows an illustrated sun in light mode and a moon with stars in dark mode." src="https://github.com/edayot/ItemIO/blob/master/docs/assets/download_ffffff.svg?raw=true"> </picture>
