...
execute unless score @s simpledrawer.new_drawer.no_format_cooldown matches 1.. at @s run data modify entity @e[tag=simpledrawer.new_drawer.part.maxcount,limit=1,predicate=simpledrawer:impl/search_id_new_drawer,distance=..10] text set value [{"interpret":true, "nbt":"format.count_int","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.dot","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.count_reminder","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.count_suffix","storage":"simpledrawer:main"},{"text":"/"},{"interpret":true, "nbt":"format.maxcount_int","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.maxdot","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.maxcount_reminder","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.maxcount_suffix","storage":"simpledrawer:main"}]
...
execute unless score @s simpledrawer.new_drawer.no_format_cooldown matches 1.. at @s run data modify entity @e[tag=simpledrawer.new_drawer.part.text_display,limit=1,predicate=simpledrawer:impl/search_id_slot_new_drawer,distance=..10] text set value [{"interpret":true, "nbt":"format.count_int","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.dot","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.count_reminder","storage":"simpledrawer:main"},{"interpret":true, "nbt":"format.count_suffix","storage":"simpledrawer:main"}]
