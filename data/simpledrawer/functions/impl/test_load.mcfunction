...
execute if score #itemio.major load.status matches 0 if score #itemio.minor load.status matches 1 if score #itemio.patch load.status matches 0 run scoreboard players set #simpledrawer.itemio load.status 1
