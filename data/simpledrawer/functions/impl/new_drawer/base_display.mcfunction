...
execute if score #if_player_around simpledrawer.math matches 1 if data storage simpledrawer:main temp.simpledrawerXX{type:"compacting",variant:"single"} run function simpledrawer:impl/new_drawer/compacting/base_display
