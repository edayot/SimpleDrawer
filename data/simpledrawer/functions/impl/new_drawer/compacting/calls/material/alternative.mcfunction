...
generate_material(
    ...
    block={
        ...
        nbt: {item:{id:"minecraft:clay",count:1},slot:0}
    },
    ingot={
        test: {id:"minecraft:clay_ball"},
        nbt: {item:{id:"minecraft:clay_ball",count:1},slot:1}
    },
    ingot_in_block=4,
    nugget_in_ingot=4,
)
...
generate_material(
    ...
    block={
        ...
        nbt: {item:{id:"minecraft:quartz_block",count:1},slot:0}
    },
    ingot={
        test: {id:"minecraft:quartz"},
        nbt: {item:{id:"minecraft:quartz",count:1},slot:1}
    },
    nugget=None,
    ingot_in_block=4,
    nugget_in_ingot=4,
...
generate_material(
    ...
    block={
        ...
        nbt: {item:{id:"minecraft:sandstone",count:1},slot:0}
    },
    ingot={
        test: {id:"minecraft:sand"},
        nbt: {item:{id:"minecraft:sand",count:1},slot:1}
    },
    nugget=None,
    ingot_in_block=4,
    nugget_in_ingot=4,
...
generate_material(
    ...
    block={
        ...
        nbt: {item:{id:"minecraft:red_sandstone",count:1},slot:0}
    },
    ingot={
        test: {id:"minecraft:red_sand"},
        nbt: {item:{id:"minecraft:red_sand",count:1},slot:1}
    },
    nugget=None,
    ingot_in_block=4,
    nugget_in_ingot=4,
