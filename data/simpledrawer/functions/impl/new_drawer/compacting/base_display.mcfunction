...
execute 
    ...
    unless data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_0
...
execute 
    store result score #count_display simpledrawer.math 
    unless data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_1
...
execute 
    store result score #count_display simpledrawer.math 
    unless data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_2
