...
execute store result score #countOutput simpledrawer.math run data get storage simpledrawer:io output.Count
...
execute store result storage simpledrawer:io output.Count int 1 run scoreboard players get #countOutput simpledrawer.math
