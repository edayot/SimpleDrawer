...
execute as @e[tag=simpledrawer.new_drawer.part.interaction_compacting,distance=..7] run function simpledrawer:impl/new_drawer/working/interaction/interact/search
