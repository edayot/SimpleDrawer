...
execute if data storage simpledrawer:main temp.current_item run function simpledrawer:impl/new_drawer/compacting/destroy_filled_2
...
data remove storage simpledrawer:main temp.current_item
data modify storage simpledrawer:main temp.current_item set from storage simpledrawer:main temp.simpledrawer.Items[{Slot:2}]
