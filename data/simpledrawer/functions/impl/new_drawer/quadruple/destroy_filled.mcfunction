...
execute store result score #count simpledrawer.math run data get storage simpledrawer:main temp.dropped_item.tag.BlockEntityTag.Items[0].tag.simpledrawer.globalCount
...
item modify entity 93682a08-d099-4e8f-a4a6-1e33a3692301 weapon.mainhand simpledrawer:destroy_maxcount
