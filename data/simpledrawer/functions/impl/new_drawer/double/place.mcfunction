...
execute positioned ^0.25 ^ ^0.51 summon item_display run function simpledrawer:impl/new_drawer/double/place/item_display
execute positioned ~ ~-0.15625 ~ positioned ^0.25 ^ ^0.4 summon interaction run function simpledrawer:impl/new_drawer/double/place/interaction
#text_display to do
