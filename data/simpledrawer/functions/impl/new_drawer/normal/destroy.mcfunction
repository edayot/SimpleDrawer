...
execute if data storage simpledrawer:main temp.simpledrawer{hopper:1b} run data modify storage simpledrawer:main temp.dropped_item.tag.display.Lore prepend value '{"translate":"simpledrawer.hopper_tier","color":"dark_gray","italic":false}'
