...
execute if score @s simpledrawer.drawer.Count0 > @s simpledrawer.drawer.maxCount0 store result storage simpledrawer:io output.Count int 1 run scoreboard players get @s simpledrawer.drawer.maxCount0
execute if score @s simpledrawer.drawer.Count0 > @s simpledrawer.drawer.maxCount0 run scoreboard players operation @s simpledrawer.drawer.Count0 = @s simpledrawer.drawer.maxCount0
...
scoreboard players operation #count_insert simpledrawer.io = @s simpledrawer.drawer.Count0
