...
scoreboard players operation #count_total simpledrawer.math += @s simpledrawer.drawer.Count0


execute if score #count_total simpledrawer.math < @s simpledrawer.drawer.maxCount0 run scoreboard players operation @s simpledrawer.drawer.Count0 = #count_total simpledrawer.math
execute if score #count_total simpledrawer.math >= @s simpledrawer.drawer.maxCount0 run scoreboard players operation @s simpledrawer.drawer.Count0 = @s simpledrawer.drawer.maxCount0
...
scoreboard players operation #count_output simpledrawer.math -= @s simpledrawer.drawer.maxCount0
...
execute if score #count_insert simpledrawer.io = @s simpledrawer.drawer.Count0 run scoreboard players set #nothing_changed simpledrawer.io 1
