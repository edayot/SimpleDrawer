...
scoreboard players operation #count_total simpledrawer.math += @s simpledrawer.drawer.Count1


execute if score #count_total simpledrawer.math < @s simpledrawer.drawer.maxCount1 run scoreboard players operation @s simpledrawer.drawer.Count1 = #count_total simpledrawer.math
execute if score #count_total simpledrawer.math >= @s simpledrawer.drawer.maxCount1 run scoreboard players operation @s simpledrawer.drawer.Count1 = @s simpledrawer.drawer.maxCount1
...
scoreboard players operation #count_output simpledrawer.math -= @s simpledrawer.drawer.maxCount1
...
execute if score #count_insert simpledrawer.io = @s simpledrawer.drawer.Count1 run scoreboard players set #nothing_changed simpledrawer.io 1
