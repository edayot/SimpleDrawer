...
data modify storage simpledrawer:main temp.ItemDrawer_no_count set from storage simpledrawer:main temp.ItemDrawer.tag.simpledrawer.Item4
...
execute if score #!same simpledrawer.math matches 0 run function simpledrawer:impl/new_drawer/working/4/fill/test_count