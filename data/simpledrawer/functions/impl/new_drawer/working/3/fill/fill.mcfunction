...
scoreboard players operation #count_total simpledrawer.math += @s simpledrawer.drawer.Count3


execute if score #count_total simpledrawer.math < @s simpledrawer.drawer.maxCount3 run scoreboard players operation @s simpledrawer.drawer.Count3 = #count_total simpledrawer.math
execute if score #count_total simpledrawer.math >= @s simpledrawer.drawer.maxCount3 run scoreboard players operation @s simpledrawer.drawer.Count3 = @s simpledrawer.drawer.maxCount3
...
scoreboard players operation #count_output simpledrawer.math -= @s simpledrawer.drawer.maxCount3
...
execute if score #count_insert simpledrawer.io = @s simpledrawer.drawer.Count3 run scoreboard players set #nothing_changed simpledrawer.io 1
