...
scoreboard players operation #count_total simpledrawer.math += @s simpledrawer.drawer.Count5


execute if score #count_total simpledrawer.math < @s simpledrawer.drawer.maxCount5 run scoreboard players operation @s simpledrawer.drawer.Count5 = #count_total simpledrawer.math
execute if score #count_total simpledrawer.math >= @s simpledrawer.drawer.maxCount5 run scoreboard players operation @s simpledrawer.drawer.Count5 = @s simpledrawer.drawer.maxCount5
...
scoreboard players operation #count_output simpledrawer.math -= @s simpledrawer.drawer.maxCount5
...
execute if score #count_insert simpledrawer.io = @s simpledrawer.drawer.Count5 run scoreboard players set #nothing_changed simpledrawer.io 1
