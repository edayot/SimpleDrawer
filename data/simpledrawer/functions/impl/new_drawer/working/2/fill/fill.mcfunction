...
scoreboard players operation #count_total simpledrawer.math += @s simpledrawer.drawer.Count2


execute if score #count_total simpledrawer.math < @s simpledrawer.drawer.maxCount2 run scoreboard players operation @s simpledrawer.drawer.Count2 = #count_total simpledrawer.math
execute if score #count_total simpledrawer.math >= @s simpledrawer.drawer.maxCount2 run scoreboard players operation @s simpledrawer.drawer.Count2 = @s simpledrawer.drawer.maxCount2
...
scoreboard players operation #count_output simpledrawer.math -= @s simpledrawer.drawer.maxCount2
...
execute if score #count_insert simpledrawer.io = @s simpledrawer.drawer.Count2 run scoreboard players set #nothing_changed simpledrawer.io 1
