...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:15}] run function simpledrawer:impl/new_drawer/working/io/15/input/if_item
