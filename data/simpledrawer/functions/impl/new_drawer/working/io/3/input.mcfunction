...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:3}] run function simpledrawer:impl/new_drawer/working/io/3/input/if_item
