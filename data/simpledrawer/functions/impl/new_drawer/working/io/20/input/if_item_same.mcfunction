...
execute store result score #initCount simpledrawer.math run data get entity @s item.tag.simpledrawer.Items[{Slot:20}].Count
...
execute store result entity @s item.tag.simpledrawer.Items[{Slot:20}].Count int 1 run scoreboard players get #newCount simpledrawer.math
