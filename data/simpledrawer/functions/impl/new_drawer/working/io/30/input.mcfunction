...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:30}] run function simpledrawer:impl/new_drawer/working/io/30/input/if_item
