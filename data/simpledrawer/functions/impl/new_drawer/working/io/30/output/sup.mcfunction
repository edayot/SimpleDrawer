...
data modify storage simpledrawer:io output set from entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:30}]
...
data remove entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:30}]
