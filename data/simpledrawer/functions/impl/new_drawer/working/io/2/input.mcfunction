...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:2}] run function simpledrawer:impl/new_drawer/working/io/2/input/if_item
