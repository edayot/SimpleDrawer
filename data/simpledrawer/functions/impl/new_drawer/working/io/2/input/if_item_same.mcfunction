...
execute store result score #initCount simpledrawer.math run data get entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:2}].count
...
execute store result entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:2}].count int 1 run scoreboard players get #newCount simpledrawer.math
