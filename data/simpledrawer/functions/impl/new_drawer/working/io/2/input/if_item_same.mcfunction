...
scoreboard players set #modified_slot simpledrawer.io 2
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_2 run scoreboard players remove #newGlobalCount simpledrawer.math 1
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_2 run scoreboard players remove #newCount simpledrawer.math 1

execute if score #newGlobalCount simpledrawer.math > #maxCount simpledrawer.math run function simpledrawer:impl/new_drawer/working/io/2/input/over
...
execute store result entity @s item.components."minecraft:container"[{slot:2}].item.count int 1 run scoreboard players get #newCount simpledrawer.math
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_2 run scoreboard players add #count_insert simpledrawer.io 1
