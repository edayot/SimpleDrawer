...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:9}] run function simpledrawer:impl/new_drawer/working/io/9/input/if_item
