...
execute store result entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:18}].Count int 1 run scoreboard players get #newCount simpledrawer.math
