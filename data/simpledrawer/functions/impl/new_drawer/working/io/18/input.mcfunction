...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:18}] run function simpledrawer:impl/new_drawer/working/io/18/input/if_item
