...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:11}] run function simpledrawer:impl/new_drawer/working/io/11/input/if_item
