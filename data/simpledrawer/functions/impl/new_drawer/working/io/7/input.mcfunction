...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:7}] run function simpledrawer:impl/new_drawer/working/io/7/input/if_item
