...
scoreboard players set #modified_slot simpledrawer.io 19
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_19 run scoreboard players remove #newGlobalCount simpledrawer.math 1
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_19 run scoreboard players remove #newCount simpledrawer.math 1
...
execute store result entity @s item.components."minecraft:container"[{slot:19}].item.count int 1 run scoreboard players get #newCount simpledrawer.math
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_19 run scoreboard players add #count_insert simpledrawer.io 1
