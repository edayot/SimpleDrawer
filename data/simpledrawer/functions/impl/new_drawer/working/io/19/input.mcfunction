...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:19}] run function simpledrawer:impl/new_drawer/working/io/19/input/if_item
