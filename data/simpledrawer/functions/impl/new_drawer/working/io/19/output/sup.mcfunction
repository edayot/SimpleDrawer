...
data modify storage simpledrawer:io output set from entity @s item.tag.simpledrawer.Items[{Slot:19}]
...
data remove entity @s item.tag.simpledrawer.Items[{Slot:19}]
