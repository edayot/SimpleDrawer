...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:14}] run function simpledrawer:impl/new_drawer/working/io/14/input/if_item
