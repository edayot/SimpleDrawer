...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:17}] run function simpledrawer:impl/new_drawer/working/io/17/input/if_item
