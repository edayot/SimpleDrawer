...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:12}] run function simpledrawer:impl/new_drawer/working/io/12/input/if_item
