...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:21}] run function simpledrawer:impl/new_drawer/working/io/21/input/if_item
