...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:25}] run function simpledrawer:impl/new_drawer/working/io/25/input/if_item
