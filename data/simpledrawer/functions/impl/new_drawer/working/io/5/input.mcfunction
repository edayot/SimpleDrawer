...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:5}] run function simpledrawer:impl/new_drawer/working/io/5/input/if_item
