...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_24 run scoreboard players remove #newGlobalCount simpledrawer.math 1


execute store result score #initCount simpledrawer.math run data get entity @s item.components."minecraft:container"[{slot:24}].item.count
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_24 run scoreboard players remove #newCount simpledrawer.math 1

execute if score #newGlobalCount simpledrawer.math > #maxCount simpledrawer.math run function simpledrawer:impl/new_drawer/working/io/24/input/over
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_24 run scoreboard players add #count_insert simpledrawer.io 1
