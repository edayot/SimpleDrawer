...
data modify storage simpledrawer:main temp.item2 set from entity @s item.components."minecraft:container"[{slot:24}].item
...
execute if score #!same simpledrawer.math matches 0 run function simpledrawer:impl/new_drawer/working/io/24/input/if_item_same
