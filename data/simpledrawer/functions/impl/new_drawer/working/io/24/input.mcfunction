...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:24}] run function simpledrawer:impl/new_drawer/working/io/24/input/if_item
