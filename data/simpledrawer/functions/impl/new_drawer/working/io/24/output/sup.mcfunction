...
data modify storage simpledrawer:io output set from entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:24}]
...
data remove entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:24}]

scoreboard players operation #search_id simpledrawer.math = @s simpledrawer.new_drawer.id
scoreboard players set #search_slot simpledrawer.math 24
