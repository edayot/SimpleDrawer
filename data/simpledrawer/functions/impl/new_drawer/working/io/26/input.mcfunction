...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:26}] run function simpledrawer:impl/new_drawer/working/io/26/input/if_item
