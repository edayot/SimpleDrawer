...
execute if score #newGlobalCount simpledrawer.math > #maxCount simpledrawer.math run function simpledrawer:impl/new_drawer/working/io/29/input/over
...
execute store result entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:29}].count int 1 run scoreboard players get #newCount simpledrawer.math
