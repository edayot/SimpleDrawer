...
data modify storage simpledrawer:main temp.item2 set from entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:29}]
...
execute if score #!same simpledrawer.math matches 0 run function simpledrawer:impl/new_drawer/working/io/29/input/if_item_same
