...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.Items[{Slot:13}] run function simpledrawer:impl/new_drawer/working/io/13/input/if_item
