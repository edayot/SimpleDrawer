...
data modify storage simpledrawer:io output set from entity @s item.tag.simpledrawer.Items[{Slot:13}]
...
execute store result entity @s item.tag.simpledrawer.Items[{Slot:13}].Count int 1 run scoreboard players get #newCount simpledrawer.math
