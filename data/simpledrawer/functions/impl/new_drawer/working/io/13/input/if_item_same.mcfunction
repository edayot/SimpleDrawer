...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_13 run scoreboard players remove #newGlobalCount simpledrawer.math 1


execute store result score #initCount simpledrawer.math run data get entity @s item.components."minecraft:container"[{slot:13}].item.count
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_13 run scoreboard players remove #newCount simpledrawer.math 1
...
execute store result entity @s item.components."minecraft:container"[{slot:13}].item.count int 1 run scoreboard players get #newCount simpledrawer.math
...
execute if data entity @s item.components."minecraft:custom_data".simpledrawer.set_count_0_13 run scoreboard players add #count_insert simpledrawer.io 1
