...
execute positioned ~ ~-0.05 ~ positioned ^ ^ ^0.505 summon item_display run function simpledrawer:impl/new_drawer/single/place/item_display
execute positioned ~ ~-0.3625 ~ positioned ^ ^ ^0.2 summon interaction run function simpledrawer:impl/new_drawer/single/place/interaction
