...
execute if score #good_item simpledrawer.math matches 1 if score #if_input simpledrawer.math matches 1 if score #if_filled simpledrawer.math matches 0 run function simpledrawer:impl/drawer/working/fill/first
execute if score #good_item simpledrawer.math matches 1 if score #if_input simpledrawer.math matches 1 if score #if_filled simpledrawer.math matches 1 run function simpledrawer:impl/drawer/working/fill/test