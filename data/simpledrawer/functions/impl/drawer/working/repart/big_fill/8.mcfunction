...
data modify storage simpledrawer:io input set from storage simpledrawer:main temp.ItemPlayer[{Slot:8b}]
function simpledrawer:impl/drawer/working/input
execute if score #success simpledrawer.io matches 1 run item modify entity @p[tag=simpledrawer.adder] container.8 simpledrawer:impl/set_count_output
