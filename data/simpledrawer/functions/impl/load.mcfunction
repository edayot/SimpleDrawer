...
data modify storage simpledrawer:main ItemsNBT.new_drawer set value {id:"minecraft:furnace",Count:1b						,tag:{CustomModelData:1430000,Trim:{material:"simpledrawer:oak",pattern:"minecraft:sentry"},HideFlags:128,ctc:{id:"new_drawer",from:"airdox_:simpledrawer",traits:{"block":1b}}										,BlockEntityTag:{Items:[{id:"minecraft:barrier",Count:1b,Slot:0b,tag:{simpledrawer:{type:"normal",variant:"single",wood_type:"simpledrawer:oak",upgrade:"wood",hopper:0b,globalCount:0,maxCount:256},smithed:{block:{id:"simpledrawer:new_drawer"}}}}]}							,display:{Name:'{"translate":"simpledrawer.new_drawer.empty","color":"white","italic":false}',Lore:['{"translate":"simpledrawer.name","color":"blue","italic":true}']}}}
data modify storage simpledrawer:main ItemsNBT.double_new_drawer set value {id:"minecraft:furnace",Count:1b						,tag:{CustomModelData:1430001,Trim:{material:"simpledrawer:oak",pattern:"minecraft:sentry"},HideFlags:128,ctc:{id:"new_drawer",from:"airdox_:simpledrawer",traits:{"block":1b}}										,BlockEntityTag:{Items:[{id:"minecraft:barrier",Count:1b,Slot:0b,tag:{simpledrawer:{type:"normal",variant:"double",wood_type:"simpledrawer:oak",upgrade:"wood",hopper:0b,globalCount:0,maxCount:256},smithed:{block:{id:"simpledrawer:new_drawer"}}}}]}							,display:{Name:'{"translate":"simpledrawer.double_new_drawer.empty","color":"white","italic":false}',Lore:['{"translate":"simpledrawer.name","color":"blue","italic":true}']}}}
data modify storage simpledrawer:main ItemsNBT.quadruple_new_drawer set value {id:"minecraft:furnace",Count:1b						,tag:{CustomModelData:1430002,Trim:{material:"simpledrawer:oak",pattern:"minecraft:sentry"},HideFlags:128,ctc:{id:"new_drawer",from:"airdox_:simpledrawer",traits:{"block":1b}}										,BlockEntityTag:{Items:[{id:"minecraft:barrier",Count:1b,Slot:0b,tag:{simpledrawer:{type:"normal",variant:"quadruple",wood_type:"simpledrawer:oak",upgrade:"wood",hopper:0b,globalCount:0,maxCount:256},smithed:{block:{id:"simpledrawer:new_drawer"}}}}]}							,display:{Name:'{"translate":"simpledrawer.quadruple_new_drawer.empty","color":"white","italic":false}',Lore:['{"translate":"simpledrawer.name","color":"blue","italic":true}']}}}



data modify storage simpledrawer:main ItemsNBT.compacting_drawer set value {id:"minecraft:furnace",Count:1b						,tag:{CustomModelData:1430000,Trim:{material:"simpledrawer:oak",pattern:"minecraft:sentry"},ctc:{id:"new_drawer",from:"airdox_:simpledrawer",traits:{"block":1b}}										,BlockEntityTag:{Items:[{id:"minecraft:barrier",Count:1b,Slot:0b,tag:{simpledrawer:{type:"compacting",variant:"single",upgrade:"wood",hopper:0b,globalCount:0,maxCount:256},smithed:{block:{id:"simpledrawer:new_drawer"}}}}]}							,display:{Name:'{"translate":"simpledrawer.new_drawer.empty","color":"white","italic":false}',Lore:['{"translate":"simpledrawer.name","color":"blue","italic":true}']}}}
...
data modify storage simpledrawer:main ItemsNBT.guide.tag.pages append value ''
