...
execute if score #if_empty_output simpledrawer.math matches 0 if score #success_output itemio.math.output matches 1 run function simpledrawer:impl/drawer/working/output_block
