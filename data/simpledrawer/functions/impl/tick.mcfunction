...
execute as @e[type=glow_item_frame,tag=simpledrawer.new_drawer,predicate=!simpledrawer:destroyer_chiseled_bookshelf] at @s run function simpledrawer:impl/new_drawer/destroy
