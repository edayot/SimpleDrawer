...
summon item ~ ~ ~ {Tags:["SD_summoned"],Age:1,PickupDelay:0,Motion:[0.0,0.1,0.0],Item:{id:"minecraft:furnace",Count:1b,tag:{SD_simpledrawer:1b,display:{Name:'{"text":"Empty Drawer","italic":false}'},BlockEntityTag:{Items:[{Slot:0b,id:"minecraft:diamond",Count:1b,tag:{info:{maxCount:256L}}}],Lock:"SD_DrawerPlacer"}}}}
