...
data modify storage simpledrawertemp ItemHopper set from block ~ ~2 ~ Items[{Slot:0b}]
...
execute if score same SD_tempC matches 0 run function simpledrawerhopper_insert/items0/insert