...
data modify storage simpledrawertemp ItemHopper set from block ~ ~2 ~ Items[{Slot:2b}]
...
execute store result block ~ ~2 ~ Items[{Slot:2b}].Count byte 1 run scoreboard players get nbhopper SD_tempC
