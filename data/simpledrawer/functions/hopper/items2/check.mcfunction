...
data modify storage simpledrawertemp ItemHopper set from block ~ ~ ~ Items[{Slot:2b}]
...
execute if score same SD_tempC matches 0 run function simpledrawerhopper/items2/extract