...
data modify storage simpledrawertemp ItemHopper set from block ~ ~ ~ Items[{Slot:0b}]
...
execute if score same SD_tempC matches 0 run function simpledrawerhopper/items0/extract