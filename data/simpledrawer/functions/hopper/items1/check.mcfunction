...
data modify storage simpledrawertemp ItemHopper set from block ~ ~ ~ Items[{Slot:1b}]
...
execute if score same SD_tempC matches 0 run function simpledrawerhopper/items1/extract