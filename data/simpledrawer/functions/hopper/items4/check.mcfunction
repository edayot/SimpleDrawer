...
data modify storage simpledrawertemp ItemHopper set from block ~ ~ ~ Items[{Slot:4b}]
...
execute if score same SD_tempC matches 0 run function simpledrawerhopper/items4/extract