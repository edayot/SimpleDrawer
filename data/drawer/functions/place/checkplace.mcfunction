...
#execute positioned ~ ~-1 ~ if data block ~ ~ ~ {Lock:"SD_DrawerPlacer"} run function drawer:place/place

setblock 0 0 0 chest{Items:[{Slot:0b,id:"minecraft:diamond",Count:1b}]} replace
item modify block 0 0 0 container.0 drawer:get_pos
...
execute at @e[type=marker,tag=SD_Placer] run function drawer:place/place
