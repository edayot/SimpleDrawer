...
execute store result score nbhopper SD_tempC run data get block ~ ~2 ~ Items[{Slot:2b}].Count
...
execute if score Count SD_tempC <= maxCount SD_tempC store result block ~ ~2 ~ Items[{Slot:2b}].Count byte 1 run scoreboard players get nbhopper SD_tempC
