...
data modify storage drawer:temp ItemHopper set from block ~ ~2 ~ Items[{Slot:4b}]
...
execute if score same SD_tempC matches 0 run function drawer:hopper_insert/items4/insert