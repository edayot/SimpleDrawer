...
execute if score nb SD_tempC matches ..0 run function drawer:working/unfill/inf64
...
execute if score nb SD_tempC matches 1.. run function drawer:working/display
