...
data modify storage drawer:temp ItemHopper set from block ~ ~ ~ Items[{Slot:1b}]
...
execute if score same SD_tempC matches 0 run function drawer:hopper/items1/extract