...
execute at @s as @e[type=minecraft:glow_item_frame,tag=simpledrawer.drawer.block,distance=..2] if score @s simpledrawer.id = #test_id simpledrawer.math run function simpledrawer:drawer/working/display/block_2
