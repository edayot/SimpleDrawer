...
execute if score #count_hopper simpledrawer.math < #count_max simpledrawer.math run function simpledrawer:drawer/working/minecart_hopper_extract/slot1/insert_2
