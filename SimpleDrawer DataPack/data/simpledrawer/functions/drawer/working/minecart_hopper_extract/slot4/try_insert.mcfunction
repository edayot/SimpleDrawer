...
data modify storage simpledrawer:main temp.ItemTry set from storage simpledrawer:main temp.ItemsHopper[{Slot:4b}]
...
execute if score #!same simpledrawer.math matches 0 run function simpledrawer:drawer/working/minecart_hopper_extract/slot4/insert
