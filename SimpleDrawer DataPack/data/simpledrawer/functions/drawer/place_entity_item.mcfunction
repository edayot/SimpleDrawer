...
execute if data storage simpledrawer:main temp.ItemPlaced.tag.simpledrawer{type:"diamond"} run scoreboard players set @s simpledrawer.drawer.maxCount 65536
execute if data storage simpledrawer:main temp.ItemPlaced.tag.simpledrawer{type:"star"} run scoreboard players set @s simpledrawer.drawer.maxCount 1048576
execute if data storage simpledrawer:main temp.ItemPlaced.tag.simpledrawer{type:"netherite"} run scoreboard players set @s simpledrawer.drawer.maxCount 1073741824
