...
execute unless entity @e[type=item,nbt={Item:{id:"minecraft:beehive"},Age:0s},limit=1,sort=nearest,distance=..1] run summon item ~ ~ ~ {Tags:["simpledrawer.dropped_item"],Item:{id:"minecraft:barrier",Count:1b}}
