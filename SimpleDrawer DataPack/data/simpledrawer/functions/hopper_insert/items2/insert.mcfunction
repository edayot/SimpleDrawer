...
execute if score Count simpledrawer.tempC <= maxCount simpledrawer.tempC store result block ~ ~2 ~ Items[{Slot:2b}].Count byte 1 run scoreboard players get nbhopper simpledrawer.tempC
