...
execute store result score nbhopper simpledrawer.tempC run data get block ~ ~2 ~ Items[{Slot:1b}].Count
...
execute if score Count simpledrawer.tempC <= maxCount simpledrawer.tempC store result block ~ ~2 ~ Items[{Slot:1b}].Count byte 1 run scoreboard players get nbhopper simpledrawer.tempC
