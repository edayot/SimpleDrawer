...
data modify storage simpledrawer:temp ItemHopper set from block ~ ~2 ~ Items[{Slot:3b}]
...
execute store result block ~ ~2 ~ Items[{Slot:3b}].Count byte 1 run scoreboard players get nbhopper SD_tempC
