data modify storage simpledrawer:temp ItemInventory set from entity @p[tag=simpledrawer.adder] Inventory[{Slot:16b}]
...
execute if data storage simpledrawer:temp {bigfilltest:0b} run function simpledrawer:working/fill/bigfill/slot16/fill
