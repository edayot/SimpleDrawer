...
execute if entity @s[tag=simpledrawer.north] run function simpledrawer:working/redstone/north
execute if entity @s[tag=simpledrawer.south] run function simpledrawer:working/redstone/south
execute if entity @s[tag=simpledrawer.east] run function simpledrawer:working/redstone/east
execute if entity @s[tag=simpledrawer.west] run function simpledrawer:working/redstone/west
