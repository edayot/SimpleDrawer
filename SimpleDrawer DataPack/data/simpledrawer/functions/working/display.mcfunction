...
execute if data entity @s Item.tag.info{type:"iron"} run scoreboard players add model SD_tempC 4
execute if data entity @s Item.tag.info{type:"gold"} run scoreboard players add model SD_tempC 8
execute if data entity @s Item.tag.info{type:"diamond"} run scoreboard players add model SD_tempC 12
execute if data entity @s Item.tag.info{type:"star"} run scoreboard players add model SD_tempC 16
execute if data entity @s Item.tag.info{type:"netherite"} run scoreboard players add model SD_tempC 20
