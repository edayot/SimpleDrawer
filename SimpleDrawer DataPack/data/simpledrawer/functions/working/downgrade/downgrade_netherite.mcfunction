execute at @p[tag=SD_adder] run summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:netherite_ingot",Count:1b,tag:{display:{Name:'{"translate":"simpledrawer.netherite_upgrade","color":"black","italic":false}'},CustomModelData:1430050,setType:"netherite"}}}
