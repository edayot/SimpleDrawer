execute at @p[tag=SD_adder] run summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:netherite_ingot",Count:1b,tag:{display:{Name:'{"text":"Netherite Upgrade","color":"black","italic":false}'},CustomModelData:16777216,setType:"netherite"}}}
