execute at @p[tag=SD_adder] run summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:diamond",Count:1b,tag:{display:{Name:'{"text":"Diamond Upgrade","color":"aqua","italic":false}'},CustomModelData:42030,setType:"diamond"}}}
