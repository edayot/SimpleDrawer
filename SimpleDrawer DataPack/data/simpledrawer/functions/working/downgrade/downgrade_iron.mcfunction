execute at @p[tag=SD_adder] run summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:iron_ingot",Count:1b,tag:{display:{Name:'{"text":"Iron Upgrade","color":"white","italic":false}'},CustomModelData:1024,setType:"iron"}}}
