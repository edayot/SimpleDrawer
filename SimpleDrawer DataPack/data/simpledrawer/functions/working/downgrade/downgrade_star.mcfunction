execute at @p[tag=SD_adder] run summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:nether_star",Count:1b,tag:{display:{Name:'{"text":"Nether Star Upgrade","color":"dark_grey","italic":false}'},CustomModelData:262144,setType:"star"}}}
