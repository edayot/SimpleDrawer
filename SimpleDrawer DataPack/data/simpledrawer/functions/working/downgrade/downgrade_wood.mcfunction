execute at @p[tag=SD_adder] run summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:flint",Count:1b,tag:{display:{Name:'{"text":"Hopper Upgrade","color":"green","italic":false}'},CustomModelData:20,setType:"hopper"}}}
