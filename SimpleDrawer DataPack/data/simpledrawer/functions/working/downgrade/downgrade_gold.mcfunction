execute at @p[tag=SD_adder] run summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:gold_ingot",Count:1b,tag:{display:{Name:'{"text":"Gold Upgrade","color":"gold","italic":false}'},CustomModelData:2048,setType:"gold"}}}
