...
execute if data storage simpledrawer:io input as @e[tag=simpledrawer.drawer_connector.same_network,tag=simpledrawer.drawer.block] run function simpledrawer:drawer_connector/try_input_nofirst/11
...
execute if score #success_connector simpledrawer.math matches 0 if data storage simpledrawer:io input as @e[tag=simpledrawer.drawer_connector.same_network,tag=simpledrawer.drawer.block] run function simpledrawer:drawer_connector/try_input_nofirst/12
...
execute if score #success_connector simpledrawer.math matches 0 if data storage simpledrawer:io input as @e[tag=simpledrawer.drawer_connector.same_network,tag=simpledrawer.drawer.block] run function simpledrawer:drawer_connector/try_input_nofirst/13
...
execute if score #success_connector simpledrawer.math matches 0 if data storage simpledrawer:io input as @e[tag=simpledrawer.drawer_connector.same_network,tag=simpledrawer.drawer.block] run function simpledrawer:drawer_connector/try_input_nofirst/14
...
execute if score #success_connector simpledrawer.math matches 0 if data storage simpledrawer:io input as @e[tag=simpledrawer.drawer_connector.same_network,tag=simpledrawer.drawer.block] run function simpledrawer:drawer_connector/try_input_nofirst/15
