...
data modify storage simpledrawer:temp ItemHopper set from block ~ ~ ~ Items[{Slot:0b}]
...
execute if score same simpledrawer.tempC matches 0 run function simpledrawer:hopper_extract/items0/extract