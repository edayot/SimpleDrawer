...
data modify storage simpledrawer:temp ItemHopper set from block ~ ~ ~ Items[{Slot:1b}]
...
execute if score same simpledrawer.tempC matches 0 run function simpledrawer:hopper_extract/items1/extract