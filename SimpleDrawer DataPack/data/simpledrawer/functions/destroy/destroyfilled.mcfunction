...
execute in simpledrawer:intern run setblock 0 -64 0 oak_sign{Text1:'[{"score":{"name":"temp","objective":"SD_tempC"},"color":"white","italic":false},{"text":" / ","color":"dark_gray","italic":false},{"nbt":"maxCount","storage":"simpledrawer:temp","color":"white","italic":false},{"translate":"simpledrawer.text.of","color":"gray","italic":false},{"nbt":"id","storage":"simpledrawer:temp","color":"gold","italic":false}]',Text2:'[{"translate":"simpledrawer.text.named","color":"gray","italic":false},{"nbt":"Name","storage":"simpledrawer:temp","interpret":true,"italic":false}]'} replace
