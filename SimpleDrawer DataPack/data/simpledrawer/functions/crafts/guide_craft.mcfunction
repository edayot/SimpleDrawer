...
tellraw @s [{"translate":"simpledrawer.tellraw_prefix","color":"dark_green"},{"translate":"simpledrawer.guide.message","color":"green","clickEvent":{"action":"open_url","value":"https://github.com/edayot/SimpleDrawer/wiki"}}]
