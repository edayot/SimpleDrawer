...
summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:stick",Count:1b,tag:{display:{Lore:['{"text":"Simple Drawer","color":"blue","italic":false}'],Name:'{"text":"Downgrade Wrench","color":"white","italic":false}'},CustomModelData:1374,downgrade:1b}}}
