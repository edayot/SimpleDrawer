...
summon item ~ ~ ~ {Tags:["SD_summoned"],Item:{id:"minecraft:gold_ingot",Count:1b,tag:{display:{Lore:['{"text":"Simple Drawer","color":"blue","italic":false}'],Name:'{"text":"Gold Upgrade","color":"gold","italic":false}'},CustomModelData:42020,setType:"gold"}}}
