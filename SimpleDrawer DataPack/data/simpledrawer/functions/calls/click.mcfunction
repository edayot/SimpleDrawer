...
execute if entity @e[tag=simpledrawer.selected,tag=simpledrawer.drawer.filled] if score #already simpledrawer.math matches 0 unless data storage simpledrawer:main temp.ItemInput if entity @s[predicate=simpledrawer:sneaking] run function simpledrawer:repart/big_unfill
execute if entity @e[tag=simpledrawer.selected,tag=simpledrawer.drawer.filled] if score #already simpledrawer.math matches 0 if data storage simpledrawer:main temp.ItemInput if entity @s[predicate=simpledrawer:sneaking] run function simpledrawer:repart/big_fill
