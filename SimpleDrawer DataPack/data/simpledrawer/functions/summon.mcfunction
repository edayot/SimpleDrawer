...
summon item ~ ~ ~ {Tags:["SD_summoned"],Age:1,PickupDelay:0,Motion:[0.0,0.1,0.0],Item:{id:"minecraft:furnace",Count:1b,tag:{SD_simpledrawer:1b,display:{Name:'{"translate":"simpledrawer.drawer.empty","italic":false}'},BlockEntityTag:{Items:[{Slot:0b,id:"minecraft:dirt",Count:1b,tag:{info:{type:"wood",hopper:0},Drawer:1b}}],Lock:"SD_DrawerPlacer"}}}}
...
data modify entity @e[type=item,tag=SD_summoned,limit=1] Item.tag.CustomModelData set value 1430000L
...
execute in simpledrawer:intern run data modify entity @e[type=item,limit=1,tag=SD_summoned] Item.tag.display.Lore append value '{"translate":"simpledrawer.name","color":"blue","italic":false}'
